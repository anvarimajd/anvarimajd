...
|---|-------------|---------|------|--------------|------|
| 1 | Dashboard | Modern Dashboard with Flexbox | [🔗](https://github.com/anvarimajd/Dashboard) |  React Native, Expo | [🎬](#) |
...
| 4 | Binary Game | Interactive Binary Number Learning Game | [🔗](https://github.com/anvarimajd/Binery_Game) | React Native, Expo, Game Logic | [🎬](#) |
| 5 | Crypto App | Cryptocurrency Price Tracking Mobile Application | [🔗](https://github.com/anvarimajd/Crypto_App) | React Native, Expo, API Integration | [🎬](https://mega.nz/embed/24AiFZpT#L8mf1ZFnrnQdgBd_H740pAcF5dTVoFwQ9EsUI9E_kbY) |
| 6 | Weather App |Application with Real-Time Weather Data | [🔗](https://github.com/anvarimajd/Weather-App) | React Native, Expo, API | [🎬](https://mega.nz/embed/Dg5HyTST#a2L4G9F00AvPYLYuhyZrbxwnPvoL92c0xEX968h4SlM) |
| 7 | Food App | Restaurant Menu and Food Ordering | [🔗](https://github.com/anvarimajd/Restaurant-App) | React Native, Expo, UI Design | [🎬](#) |
| 8 | Shop Begi... |  | [🔗](#) | Cisco Packet Tracer, VLAN, Routing, OSPF | [🎬](#) |
