...
|---|---------|-------------|--------|--------------|
| 1 | Dashboard | Modern Personal Management Dashboard UI | [🔗](https://github.com/anvarimajd/Dashboard) | HTML, CSS, JavaScript, Tailwind CSS |
| 2 | BMI App | Body Mass Index Calculator Mobile Application | [🔗](https://github.com/anvarimajd/BMI-Calculator) | React Native, Expo, JavaScript |
